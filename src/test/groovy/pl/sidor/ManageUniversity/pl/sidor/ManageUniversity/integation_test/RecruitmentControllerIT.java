...
public class RecruitmentControllerIT {
    ...
    public void should_find_candidate_by_id() throws Exception {
        ...
        // expected
        mockMvc.perform(MockMvcRequestBuilders.get("/recruitment/{id}",candidate.getId()))
                .andDo(print())
    ...
    public void should_throw_exception_find_candidate_by_id() throws Exception {
        ...
        // expected
        mockMvc.perform(MockMvcRequestBuilders.get("/recruitment/{id}",99999L))
                .andDo(print())
    ...
    public  void should_delete_candidate() throws Exception {
        ...
        // expected
        mockMvc.perform(MockMvcRequestBuilders.delete("/recruitment/{id}",candidate.getId()))
                .andDo(print())
                .andExpect(status().isOk());
    }
    ...
    public  void should_throw_exception_delete_candidate() throws Exception {
        ...
        // expected
        mockMvc.perform(MockMvcRequestBuilders.delete("/recruitment/{id}",id))
                .andDo(print())
                .andExpect(status().isNotFound());
    }
    ...
    public void  should_create_candidate() throws Exception {
        ...
        // expected
        mockMvc.perform(MockMvcRequestBuilders.post("/recruitment/save")
